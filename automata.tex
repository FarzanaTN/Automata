...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{slide_1_dfa/sub.png}
    \caption{Caption}
...
\node[state, initial] (q17) {$q_{17}$};
\node[state] (q10) [right=of q17] {$q_{10}$};
\node[state, accepting, right=of q10] (q20) {$q_{20}$};

\path
(q17) edge[above] node{$\varepsilon$} (q10)
(q17) edge[bend left, above] node{$\varepsilon$} (q20)
(q10) edge[loop above] node{$\varepsilon$} ()
    ;
    \end{tikzpicture}
\section{FA to RE}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{pictures/ar1.png}
    \caption{Caption}
    \label{fig:placeholder}
\end{figure}
P = 0*\\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{pictures/ar2.png}
    \caption{Caption}
    \label{fig:placeholder}
\end{figure}
A = ( 0 + 1 + ( 1 ( 1 + 01 )* 00 )*
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{pictures/ar3.png}
    \caption{Caption}
    \label{fig:placeholder}
\end{figure}
A = ( 0 + 1 ( 1 + 011)* (00+010))*\\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{27_incourse/ar_27.png}
    \caption{Caption}
    \label{fig:placeholder}
\end{figure}
A = ((0+1) + 0 (0+1)*10*1)*
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{27_incourse/ar_final.png}
    \caption{Caption}
    \label{fig:placeholder}
\end{figure}
